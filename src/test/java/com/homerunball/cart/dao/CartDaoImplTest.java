...
public class CartDaoImplTest {
    ...
    public void countTest() throws Exception{
        ...
        CartDto cart = new CartDto(c_id, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
    ...
    public void cidDeleteAll() throws Exception {
        ...
        int c_id = cartDao.getcustAll().get(0).getC_id();
        CartDto cart = new CartDto(c_id, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
        CartDto cart2 = new CartDto(c_id, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.insert(cart2)==1);

        /* 1번고객이 장바구니에 1개추가 총 count는 3개 */
        int c_id2 = cartDao.getcustAll().get(1).getC_id();
        CartDto cart3 = new CartDto(c_id, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
        assertTrue(cartDao.insert(cart3)==1);
        assertTrue(cartDao.count()==3);

        /* 1번고객의 장바구니를 전체삭제 */
        assertTrue(cartDao.cidDeleteAll(cart2.getC_id())==3);
        /* 남은데이터는 0건 */
        assertTrue(cartDao.count()==0);

        List<CartDto> list = cartDao.selectAll();
        /* cart에 남아있는 list의 개수도 0개 */
    ...
    public void insertTest() throws Exception {
        ...
        cart = new CartDto(c_id, "GLV000021-20", "pd", "img", "pd_name", "","pd_type_cd", 2,  0, 0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.count()==2);
    ...
    public void selectUserTest() throws Exception {
        ...
        CartDto cart = new CartDto(cid, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
        assertTrue(cartDao.insert(cart)==1);

        /* 1번째고객이 장바구니에 물건을 담는다 */
        int cid2 = cartDao.getcustAll().get(1).getC_id();
        CartDto cart2 = new CartDto(cid2, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
    ...
    public void cartCheckTest() throws Exception {
        ...
        /* 0번째고객이 장바구니에 물건을 담는다 */
        CartDto cart = new CartDto(100003, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
        CartDto cart2 = new CartDto(100003, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
        CartDto cart3 = new CartDto(100004, "GLV000021-20", "pd", "img", "","pd_name", "pd_type_cd", 2,  0, 0);
        assertTrue(cartDao.insert(cart)==1);
        assertTrue(cartDao.insert(cart2)==1);
        assertTrue(cartDao.insert(cart3)==1);
        assertTrue(cartDao.count()==3);
